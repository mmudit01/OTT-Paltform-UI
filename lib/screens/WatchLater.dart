...
class _GenreState extends State<watchLater> {
  @override
  void initState() {
    checkUserId();
    super.initState();
        ...
        child: SingleChildScrollView(
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                watchLaterMovies(context),
                SizedBox(height: 30,),
                watchLaterTvShows(context),
              ],
            ),
          ),
        ),
  ...
  Widget watchLaterTvShows(BuildContext context) {
    return Column(
      children: [
        Text(
          'Tv Show',
        ...
        FutureBuilder(
          future: APIprovider().getWatchLaterTv(userId),
          builder: (context, snapshot) {
            print(snapshot);
            return snapshot.data == null || snapshot.data.length == 0
                ? Center(
                    child: Text(
                      "You haven't added any Tv shows to Favorites",
                    ),
                  )
                : Container(
                                ...
                                child: TextButton(
                                    ...
                                    onPressed: () async {
                                      ...
                                      var res = await http.post(
                                          Uri.encodeFull(
                                              'https://api.shott.tech/api/removewatchlist_tv/$id'),
                                          headers: {
  ...
  Widget watchLaterMovies(BuildContext context) {
    return Column(
      children: [
        Text(
          'Movies',
        ...
        FutureBuilder(
          future: APIprovider().getWatchLater(userId),
          builder: (context, snapshot) {
            //print(snapshot);
            return snapshot.data == null || snapshot.data.length == 0
                ? Center(
                              ...
                              Container(
                                ...
                                child: TextButton(
                                    ...
                                    onPressed: () async {
                                      ...
                                      var res = await http.post(
                                          Uri.encodeFull(
                                              'https://api.shott.tech/api/removewatchlist/$id'),
                                          headers: {
                                            "Accept": "application/json"
                                          },
                                          body: {
