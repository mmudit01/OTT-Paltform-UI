...
import 'package:shott_app/screens/FavAndWatchTabs/WatchMovies.dart';
import 'package:shott_app/screens/FavAndWatchTabs/WatchTvShow.dart';
...
class _FavAndWatchTabState extends State<WatchTab> with SingleTickerProviderStateMixin{
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: TabBarView(
        ...
        children: [WatchMovie(),WatchTvShow()],
      ),
