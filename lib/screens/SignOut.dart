...
class _SignInPageState extends State<SignOutPage> {
  @override
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  button(context, "Sign Out with Google+", () async {
                    final pref = await SharedPreferences.getInstance();
                    await pref.clear();
                    AuthService().signOutGoogle().then((val)  {
                      print("done");
